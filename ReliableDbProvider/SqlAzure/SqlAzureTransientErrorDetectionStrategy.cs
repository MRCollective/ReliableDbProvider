...
namespace ReliableDbProvider.SqlAzure
{
    ...
    {
        private readonly Microsoft.Practices.EnterpriseLibrary.WindowsAzure.TransientFaultHandling.SqlAzure.SqlAzureTransientErrorDetectionStrategy _entLibStrategy = new Microsoft.Practices.EnterpriseLibrary.WindowsAzure.TransientFaultHandling.SqlAzure.SqlAzureTransientErrorDetectionStrategy();
        ...
        private static bool IsNewTransientError(Exception ex)
        {
